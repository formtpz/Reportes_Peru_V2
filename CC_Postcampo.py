...
def CC_Postcampo(usuario,puesto):
  ...
  with ph_main.container():
      ...
      numero_lote_3 = st.multiselect(
          "Número de Lote",
          options=lotes,
          key="numero_lote_3_postcampo"
      )
      ...
      operador_3 = st.selectbox(
          ...
          key="operador_3_postcampo"
      )
      
      tipo_3 = st.selectbox(
          "Tipo", 
          options=("Inspección", "Inspección Reproceso", "Primera Reinspección", "Inspección Horas Extras", "Control de Calidad Supervisión"),
          key="tipo_3_postcampo"
      )
      
      tipo_de_errores_3 = st.multiselect(
          "Tipo Errores", 
          options=("Atributos incompletos/erroneos", "Autoensamblado", "Diferencia de áreas", 
                  "Errores gráficos", "Puertas no coinciden", "Recapitulación errónea"),
          key="tipo_de_errores_3_postcampo"
      )
